...
def main():
    ...
    direct = pd.read_parquet(root/"production_results/reduced/prediction.parquet")
    ...
    report = dict(valid=True, mode="official LocalRunner with provided-data download override only",
